...
public class Soutien implements Serializable {
    ...
    public String toString() {
        return "Soutien{" + "id=" + id + ", descriptif=" + descriptif + ", dateDemande=" + dateDemande + ", dateDebut=" + dateDebut + ", duree=" + duree.getTime()/1000/60/60 + ", evalEleve=" + evalEleve + ", BilanInter=" + BilanInter + ", eleve=" + eleve + ", intervenant=" + intervenant + ", matiere=" + matiere + '}';
    }
